...
`oworker-aclip` is the canonical Python SDK for ACLIP, the Agent Command Line Interface Protocol.
...
If you want the canonical dependency name in project manifests, prefer `oworker-aclip`.
...
Use `oworker-aclip` when you want a CLI that still feels natural to command-line users while giving agents:
...
- <https://github.com/oworker-dev/oworker-aclip>
